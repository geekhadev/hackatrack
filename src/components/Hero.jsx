    ...
    <section className="py-16 mx-auto max-w-5xl">
      <div className="flex flex-col gap-6">
        <h1 className="text-5xl font-bold text-blance text-gray-100">
          <span className="text-7xl text-yellow-500">Tracks formativos</span> <br />
          <span>y material de estudio.</span>
        </h1>
        <p className="text-balance text-gray-400">
          Mantente actualizado con las tecnologías más demandadas del mercado.
          Gracias a nuestros tracks en HACKABOSS te convertirás en un
          profesional del desarrollo.{' '}
          <span className="text-yellow-500">
            Complete tus habilidades del Bootcamp!
          </span>
        </p>
        <div className="flex gap-4 flex-wrap">
          <a
            href="/tracks/completed"
            className="
